...
class Orchestrator:
    ...
    def __init__(self):
        ...
        self.intent_definitions = {
            ...
            "fast_model_pipeline": "Train a model without me in loop, train model with all steps fast, do preprocessing fast, build model automatically, fast pipeline, skip all interactions, automated machine learning, automl, fast model building, quick model training, hands-off modeling, automatic pipeline, no interaction needed, build model fast, train without intervention, automated workflow, streamlined modeling, express model building, rapid model development, one-click modeling, instant model creation, fast track modeling, accelerated pipeline, quick ML workflow, speed modeling, turbo mode, fast mode, without me, pass everything, auto continue, skip interactions, fully automated, end-to-end automation, complete automation, hands-free modeling, zero interaction modeling, automatic model generation, self-service modeling, autonomous pipeline, intelligent automation, smart modeling, effortless model building, seamless automation, background processing, auto pilot mode, continuous automation, unattended processing.",
...
Respond with ONLY one word: preprocessing, feature_selection, model_building, general_query, code_execution, or full_pipeline"""
    ...
    def _route_by_intent(self, state: PipelineState, intent: str) -> str:
        ...
        elif intent == "fast_model_pipeline":
            # Route to fast model pipeline agent
            print_to_log("[Orchestrator] 🚀 Fast model pipeline requested - routing to automated pipeline")
            return "fast_model_pipeline"
